package com.company.fms.security;
...
public class SecurityConfig {
    ...
    /**
     * Local-only identity so the demo UI can exercise the real API/database without
     * a Keycloak-issued JWT. This is what stops otherwise-authenticated requests from
     * turning into 403s during local development (enabled by default; disable with
     * FMS_DEV_AUTH=false in production).
     */
    @Bean
        ...
        return new OncePerRequestFilter() {
            ...
            protected void doFilterInternal(jakarta.servlet.http.HttpServletRequest request,
                ...
                if (devAuth && request.getRequestURI().startsWith("/api/")
                    ...
                    var authorities = List.of("ROLE_admin", "ROLE_finance_manager", "ROLE_general_accountant",
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedHeaders(List.of("Authorization", "Content-Type", "X-Mock-Roles"));
